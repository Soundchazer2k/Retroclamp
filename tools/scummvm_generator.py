...
class ScummVMGenerator(QWidget):
    ...
    def setup_ui(self):
        ...
        # Description
        desc_label = QLabel(
            "Generate SCUMMVM configuration files (.scummvm) for your compressed "
            "game files. These files help SCUMMVM identify and launch your games "
            "correctly."
        )
        ...
        self.platform_combo.addItems(
            ["pc", "amiga", "atari", "macintosh", "windows", "dos"]
        )
    ...
    def generate_config(self):
        ...
        try:
            ...
            QMessageBox.critical(
                self, "Error", f"Failed to create configuration file:\n{str(e)}"
            )
