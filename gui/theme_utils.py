...
def get_theme_color(color_name: str, theme: Optional[ThemeConfig] = None) -> str:
    ...
    Args:
        ...
        theme: Optional theme to get the color from. If None, uses the default dark theme.
...
def get_contrasting_text_color(bg_color: Union[str, QColor], dark: str = "#000000", light: str = "#ffffff") -> str:
