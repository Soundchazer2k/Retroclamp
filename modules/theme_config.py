...
class ThemeConfig:
    ...
    def __init__(self, config_dir: Optional[str] = None):
        ...
        """
        self.config_dir: str = config_dir or os.path.join(os.getcwd(), "config")
    ...
    def load_theme(self, theme_name: str = "theme") -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            return cast(Dict[str, Any], theme_config)
                    ...
                    themes.append(
                        {
                            ...
                            "displayName": data.get(
                                "displayName",
                                data.get("name", os.path.splitext(filename)[0]),
                            ),
    ...
    def save_theme(
        self, theme_config: Dict[str, Any], theme_name: Optional[str] = None
    ) -> bool:
