    ...
    tasks.append(
        {
            ...
            "description": (
                "Create a singleton JobManager class to handle all job processing."
            ),
            "priority": "high",
            "status": "pending",
            "dependencies": [],
    ...
    tasks.append(
        {
            ...
            "description": (
                "Create utility for handling archive extraction and pruning."
            ),
            "priority": "high",
            "status": "pending",
            "dependencies": [],
    ...
    tasks.append(
        {
            ...
            "description": (
                "Create a manager for saving and restoring processing state."
            ),
            "priority": "high",
            "status": "pending",
    ...
    tasks.append(
        {
            ...
            "dependencies": [
                ...
                2,
                4,
            ],  # Depends on JobManager, ArchiveUtils, and CheckpointManager
            "details": """
        - Connect UI to JobManager
